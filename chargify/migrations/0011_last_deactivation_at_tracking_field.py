...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.last_deactivation_at'
        db.add_column('chargify_subscription', 'last_deactivation_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.last_deactivation_at'
        db.delete_column('chargify_subscription', 'last_deactivation_at')
