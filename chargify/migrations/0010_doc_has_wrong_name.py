...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.next_assessment_at'
        db.add_column('chargify_subscription', 'next_assessment_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.next_assessment_at'
        db.delete_column('chargify_subscription', 'next_assessment_at')
